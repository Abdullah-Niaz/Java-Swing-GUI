...
public class mainUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jTextField1.getText().trim().isEmpty()){ 
            JOptionPane.showMessageDialog(mainUI.this, "Enter Your Name Again it's empty");
            jLabel1.grabFocus();
          return;
        }
        else if(jTextField2.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(mainUI.this, "Enter Your Password Again it's empty");
            jLabel2.grabFocus();
            return;
        }
        else{
            JOptionPane.showMessageDialog(mainUI.this, "Name: " + jTextField2.getText() +  "\nPassword: "+ jTextField1.getText());
        }
